...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [1] = LAYOUT_split_3x6_3(
      KC_NO, TG(1),      MS_WHLL,       MS_WHLR,       OSM(MOD_LALT), KC_NO,      /*****************/ KC_NO, KC_1, KC_2, KC_3, TG(1), KC_NO,
   ...
   [2] = LAYOUT_split_3x6_3(
      KC_NO, TG(2),  MS_WHLD, KC_UP,   MS_WHLU,  KC_NO, /*****************/ KC_NO, OSM(MOD_RALT), MS_WHLL,       MS_WHLR,       TG(2), KC_NO,
