...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x6_3(
      KC_NO, KC_1,  KC_2,  KC_3,  KC_4,  KC_5,         LSFT(KC_1), LSFT(KC_2), LSFT(KC_3), LSFT(KC_4), LSFT(KC_5), KC_NO,
      KC_NO, KC_6,  KC_7,  KC_8,  KC_9,  KC_0,         LSFT(KC_6), LSFT(KC_7), LSFT(KC_8), LSFT(KC_9), LSFT(KC_0), KC_NO,
      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,
                         KC_NO, KC_NO, KC_TRNS,        MO(3), KC_NO, KC_NO
  ),
    [2] = LAYOUT_split_3x6_3(
      KC_NO, KC_LEFT,       KC_DOWN,       KC_UP,         KC_RGHT,       KC_NO,        KC_NO, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_NO,
      KC_NO, LSFT(KC_LBRC), LSFT(KC_RBRC), LSFT(KC_RBRC), LSFT(KC_RBRC), KC_NO,        KC_NO, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_NO,
      KC_NO, KC_NO,         LSFT(KC_GRV),  LSFT(KC_QUOT), LSFT(KC_BSLS), KC_NO,        KC_NO, KC_NO,   KC_GRV,  KC_QUOT, KC_BSLS, KC_NO,
